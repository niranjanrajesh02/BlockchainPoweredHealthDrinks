...
async function main() {
  ...
  try {
    ...
    try {
      ...
      await contract.submitTransaction('ValidatePurchase', outletID, purchaseID);
      console.log(`*** Result: validated purchase ${purchaseID} for outlet ${outletID}`);
